	...
	return (
		...
		>
			...
			<View style={{ marginVertical: SIZES.font }}>
				<Text style={{ fontFamily: FONTS.regular, color: COLORS.white, fontSize: SIZES.small }}>Hello, Jimmy ✋</Text>
				<Text style={{ fontFamily: FONTS.bold, color: COLORS.white, fontSize: SIZES.large, marginTop: SIZES.base / 2 }}>Let's find a masterpiece</Text>
			</View>
